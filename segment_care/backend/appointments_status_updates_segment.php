...
$rowb = $res->fetch();
echo $patient_fullname=htmlentities($rowb['fullname'], ENT_QUOTES, "UTF-8");
...
var track = analytics.track('$appointment_approved', {
  Name: '$fullname',
  Email: '$email',
  Notes: 'Medical Staff/Doctor($fullname) Approved Patients($patient_fullname) Medical Appointment..'
});
